...
urlpatterns = [
    ...
    path('dashboard/staff/order/search/', views.DashboardSearch.as_view(), name='dashboard_search'),
    path('dashboard/staff/order/<pk>', views.dashboard_order_details, name='dashboard_order_details'),
    path('dashboard/staff/order/<pk>/update', views.order_update, name='dashboard_order_update'),
    path('dashboard/staff/order/<pk>/delete', views.order_delete, name='dashboard_order_delete'),
